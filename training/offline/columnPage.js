	...
	var columnPage = new function() {
		...
		this.init = function() {
			...
			$(x_currentPageXML).children().each(function(i) {
				...
				var infoString = $('<p>' + x_addLineBreaks(this.getAttribute("text")) + '</p>').length == 1 ? '<p>' + x_addLineBreaks(this.getAttribute("text")) + '</p>' : x_addLineBreaks(this.getAttribute("text")),
